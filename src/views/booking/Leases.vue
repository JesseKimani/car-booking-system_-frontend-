...
const bookingFields = [
  ...
  { label: 'Contract Number', name: 'contract_number', type: 'text' },
...
const fetchBookings = async () => {
  try {
    const response = await axios.get(`${API_ENDPOINT}/leases`);
...
const addBooking = async () => {
  try {
    await axios.post(`${API_ENDPOINT}/leases`, newBooking.value);
    closeAddModal();
    fetchBookings();
  } catch (error) {
    console.error(error);
...
const updateBooking = async () => {
  try {
    await axios.put(`${API_ENDPOINT}/leases/${currentBooking.value.id}`, currentBooking.value);
    closeEditModal();
    fetchBookings();
  } catch (error) {
    console.error(error);
...
const deleteBooking = async () => {
  try {
    await axios.delete(`${API_ENDPOINT}/leases/${bookingToDelete.value.id}`);
    closeDeleteModal();
    fetchBookings();
  } catch (error) {
    console.error(error);
