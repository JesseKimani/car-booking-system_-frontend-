      ...
      <table>
        ...
        <tbody>
          <tr v-for="supplier in paginatedSuppliers" :key="supplier.id">
            <td>{{ supplier.id }}</td>
            <td>{{ supplier.name }}</td>
            <td>{{ getSupplierCategory(supplier.category) }}</td>
    ...
    <Modal v-if="showAddModal" @close="closeAddModal">
      ...
      <template #body>
        <form @submit.prevent="addSupplier">
          ...
          <select v-model="newSupplier.category" placeholder="Category">
    ...
    <Modal v-if="showEditModal" @close="closeEditModal">
      ...
      <template #body>
        <form @submit.prevent="updateSupplier">
          ...
          <select v-model="currentSupplier.category" placeholder="Category">
            <option v-for="category in categories" :key="category.id" :value="category.id">
              {{ category.name }}
            </option>
          </select>
...
const getSupplierCategory = (supplierCategory) => {
  const category = categories.value.find(category => category.id === supplierCategory)
